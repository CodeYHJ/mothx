...
func init() {
	...
	entries := map[MessageID][2]string{
		...
		MsgSettingsFieldDefaultModel: {"Default Provider / Model", "默认 Provider / 模型"}, MsgSettingsFieldDefaultThinking: {"Default Thinking Level", "默认思考级别"}, MsgSettingsFieldDefaultMode: {"Default Mode", "默认模式"}, MsgSettingsFieldTheme: {"Theme", "主题"}, MsgSettingsFieldEnablePlanTool: {"Enable Plan Tool", "启用计划工具"}, MsgSettingsFieldMaxContextTokens: {"Max Context Tokens", "最大上下文 Token"}, MsgSettingsFieldUpdateCheck: {"Update Check", "更新检查"}, MsgSettingsFieldProvider: {"Provider", "Provider"}, MsgSettingsFieldProviderType: {"Provider Type", "Provider 类型"}, MsgSettingsFieldModel: {"Model", "模型"}, MsgSettingsFieldImageEnabled: {"Image Generation Enabled", "启用图片生成"}, MsgSettingsFieldImageProvider: {"Image Generation Provider", "图片生成 Provider"}, MsgSettingsFieldImageAPIType: {"Image Generation API Type", "图片生成 API 类型"}, MsgSettingsFieldImageBaseURL: {"Image Generation Base URL", "图片生成 Base URL"}, MsgSettingsFieldImageToken: {"Image Generation Token", "图片生成 Token"}, MsgSettingsFieldImageModel: {"Image Generation Model", "图片生成模型"}, MsgSettingsFieldExtraFiles: {"Extra Files", "额外文件"}, MsgSettingsFieldReserveTokens: {"Reserve Tokens", "预留 Token"}, MsgSettingsFieldKeepRecentTokens: {"Keep Recent Tokens", "保留最近 Token"}, MsgSettingsFieldTokenizer: {"Tokenizer", "Tokenizer"}, MsgSettingsFieldTokenizerModel: {"Tokenizer Model", "Tokenizer 模型"}, MsgSettingsFieldTemplate: {"Template", "模板"}, MsgSettingsFieldLevel: {"Level", "级别"}, MsgSettingsFieldBwrapPath: {"Bwrap Path", "Bwrap 路径"}, MsgSettingsFieldAllowedRead: {"Allowed Read", "允许读取"}, MsgSettingsFieldAllowedWrite: {"Allowed Write", "允许写入"}, MsgSettingsFieldDeniedPaths: {"Denied Paths", "拒绝路径"}, MsgSettingsFieldPassEnv: {"Pass Env", "传递环境变量"}, MsgSettingsFieldTmpSize: {"Tmp Size", "临时目录大小"}, MsgSettingsFieldSessionDir: {"Session Dir", "会话目录"}, MsgSettingsFieldSkillsDir: {"Skills Dir", "Skill 目录"}, MsgSettingsFieldShellPath: {"Shell Path", "Shell 路径"}, MsgSettingsFieldShellCommandPrefix: {"Shell Command Prefix", "Shell 命令前缀"}, MsgSettingsFieldMaxRetries: {"Max Retries", "最大重试次数"}, MsgSettingsFieldBaseDelay: {"Base Delay", "基础延迟"}, MsgSettingsFieldConfirmBeforeWrite: {"Confirm Before Write", "写入前确认"}, MsgSettingsFieldBashWhitelist: {"Bash Whitelist", "Bash 白名单"}, MsgSettingsFieldBashBlacklist: {"Bash Blacklist", "Bash 黑名单"},

...
<style>
  ...
  .mcp-server-list { display: grid; gap: 12px; padding: 14px; border-top: 1px solid var(--border-subtle); background: var(--bg-secondary); }.mcp-server-card { display: grid; gap: 14px; padding: 14px; border: 1px solid var(--border-subtle); border-radius: 8px; background: var(--bg-primary); }.mcp-server-card > header, .mcp-list-head { display: flex; align-items: center; justify-content: space-between; gap: 10px; }.mcp-server-card > header strong { font-size: 13px; }.mcp-fields { display: grid; grid-template-columns: minmax(160px, 1fr) minmax(130px, .45fr); gap: 10px; }.mcp-fields label { display: grid; gap: 4px; color: var(--text-secondary); font-size: 12px; font-weight: 500; }.mcp-fields .full { grid-column: 1 / -1; }.mcp-fields input, .mcp-fields select, .mcp-list-row input, .mcp-pair-row input { min-width: 0; width: 100%; }
  ...
  :global(.mcp-session-overlay) { position: fixed; z-index: 40; inset: 0; display: grid; place-items: center; padding: 20px; background: color-mix(in srgb, var(--bg-primary) 56%, transparent); overflow: auto; }:global(.mcp-session-dialog) { width: min(900px, 100%); max-height: calc(100vh - 40px); overflow: auto; padding: 20px; border: 1px solid var(--border); border-radius: 12px; background: var(--bg-primary); box-shadow: 0 20px 60px color-mix(in srgb, #000 45%, transparent); }:global(.mcp-session-head) { display: flex; align-items: center; justify-content: space-between; gap: 16px; margin-bottom: 16px; }:global(.mcp-session-head > div) { display: grid; gap: 3px; }:global(.mcp-session-head span) { color: var(--text-muted); font-size: 12px; }
